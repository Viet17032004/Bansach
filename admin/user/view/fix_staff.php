...
if(!checkPermission($group_id, 'staff', 'fix_staff')){
...
if(is_Post()){
    ...
    redirect('?module='.$module.'&action=fix_staff&id='.$id);
}
...
<div class="container_my">
    ...
    <hr>                
    <a href="?module=user&action=lists_staff" class="btn btn-success mb-3">Danh sách</a>               
