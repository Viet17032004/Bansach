...
if(!checkPermission($group_id, 'user', 'fix_user')){
...
if(!empty($body['id'])){
    $id = $body['id'];
    require _WEB_PATH_ROOT.'/admin/user/model/fix_user.php';
...
if(is_Post()){
    ...
    redirect('?module='.$module.'&action=fix_user&id='.$id);
}
...
<div class="container_my">
    ...
    <hr>                
    <a href="?module=user&action=lists_user" class="btn btn-success mb-3">Danh sách</a>               
