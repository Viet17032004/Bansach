...
<div>
    ...
    ?>
        ...
        <tr>
            ...
            <?php if(checkPermission($group_id, 'exam_type', 'delete')): ?>
            <td class="board_td text-center">
                <a href="?module=exam_type&action=delete&id=<?php echo $id; ?>" onclick="return confirm('bạn có chắc chắc muốn quá không !!!');" class="btn btn-danger"><i class="fa fa-trash-alt "></i></a>
            </td>
            <?php endif; ?>
        </tr>
