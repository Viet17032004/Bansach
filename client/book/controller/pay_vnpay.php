...
$vnp_Returnurl = "http://localhost/-Nhom05_WebBanHang_SAMRTFL/?module=book&action=thank";
...
<?php
    ...
    $vnp_TxnRef = getSession('cart_book')['code_cart']; //Mã đơn hàng. Trong thực tế Merchant cần insert đơn hàng vào DB và gửi mã này sang VNPAY
    $vnp_OrderInfo = 'Thanh toán đơn hàng tại website';
    $vnp_OrderType = 'billpayment';
    $vnp_Amount = getSession('cart_book')['total'] * 100;
    $vnp_Locale = 'vn';
    $vnp_BankCode = "NCB";
